...
for i=1:num
    ...
    %Linearized KF
    [dxLKF,P,NIS_LKF(i,:)] = LKF(zeros(6,1),P0,time,FkLKF,GkLKF,dukLKF,OmegakLKF,QLKF,Rtrue,HkLKF,dyLKF);
    xLKF = xnom + dxLKF;
...
for i=1:num  
    %Extended KF
    [xEKF,P,NIS_EKF(i,:)] = EKF(inishcondish,P0,time,f,A,Omegak,QEKF,Rtrue,meas,C,noisymeas(:,:,i));
